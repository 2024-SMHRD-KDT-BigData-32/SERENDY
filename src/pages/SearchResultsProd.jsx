...
const SearchResultsProd = () => {
  ...
  const getCategoryProducts = () => {
    ...
    return results.filter(product => subCategories.includes(product.prodCate?.trim()));
  };
  ...
  return (
    <div className="arpContainer">
      <div className="arpTitle">Search results for
        <span> '{query}'</span>
      </div>
      ...
      <div className={`productsGrid grid-${gridType}`}>
        {isLoading ? (
          ...
          <div className="loadText">검색 결과가 없습니다.</div>
        ) : (
          <>
...
export default SearchResultsProd