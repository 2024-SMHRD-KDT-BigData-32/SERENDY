...
public class CbfController {
    ...
    public CbfController(CbfService recomdService, FeedbackService feedbackService, StylePrefService stylePrefService, ProductInfoRepository productInfoRepository) {
...
//        String userId = userPreference.getId(); // 사용자 id 받아오기
		...
		List<Integer> dislikedProdIds = dislikedFeedbacks.stream()
     	...
     	// prodId, score(유사도 점수)
        List<CbfProdResponse> recommended = recomdService.recommendProductsByStyle(preferredStyles, dislikedProdIds, 3000);
...
//        String userId = userPreference.getId(); // 사용자 id 받아오기
		...
		List<Integer> dislikedProdIds = dislikedFeedbacks.stream()
     	...
     	// prodId, score(유사도 점수)
        List<CbfProdResponse> recommended = recomdService.recommendProductsByStyle(preferredStyles, dislikedProdIds, 10);
        ...
        List<ProductInfo> productDetails = productInfoRepository.findByProdIdIn(prodIdList);
