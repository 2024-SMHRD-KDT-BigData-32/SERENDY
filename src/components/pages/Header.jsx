...
const Header = () => {
  ...
  const handleSearch = () => {
    if (searchText.trim()) {
      navigate(`/searchresultsprod?query=${encodeURIComponent(searchText.trim())}`);
      setSearchText(''); // 검색 후 input 비우기
    ...
    <header>
      ...
      <nav className="categoryNav">
        ...
        <div
          ...
          onClick={() => handleNavigate('/allrecomdprod', 'RECOMMEND')}
        >
          RECOMMEND
        </div>
        <div
      ...
      <button onClick={logout} className="headerMenuLogout">
